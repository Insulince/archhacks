export class NDB_Nutrition_Response {
  foods: Array<NDB_Nutrition_Food> = [];
  count: number;
  notfound: number;
  api: number;
  ...
  constructor(rawResponse: any) {
    rawResponse.foods.forEach(
      (rawFood: any): void => {
        this.foods.push(new NDB_Nutrition_Food(rawFood));
      }
    );
...
export class NDB_Nutrition_Food {
  sr: string;
  type: string;
  desc: NDB_Nutrition_Description;
  ...
  constructor(rawFood: any) {
    ...
    this.desc = new NDB_Nutrition_Description(rawFood.desc);
...
export class NDB_Nutrition_Description {
  ndbno: string;
  name: string;
  ds: string;
  manu: string;
